...
expression_statement:expression SEMICOLON { if(found_arr_name!=0) {f=9;yyerror();} equals_seen=0; printf("\tReduced : expression_statement -> expression SEMICOLON\n");}
					|SEMICOLON { if(found_arr_name!=0) {f=9;yyerror();}equals_seen=0; printf("\tReduced : expression_statement -> SEMICOLON\n");}
					;
